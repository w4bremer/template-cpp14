...
const config = {
  title: 'C++ template',
  tagline: 'Extend your c++ project with data in minutes',
  ...
  customFields: {
    heroText: 'C++ ApiGear technology template'
  },
  presets: [
    [
      'classic',
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/apigear-io/template-cpp14/edit/main/',

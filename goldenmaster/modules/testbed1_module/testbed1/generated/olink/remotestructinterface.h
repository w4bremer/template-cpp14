...
*     It provides a network implementation and tools to connect RemoteStructInterface to it.
...
public:
    ...
    /** ctor */
    explicit RemoteStructInterface();
    /** dtor */
    virtual ~RemoteStructInterface() = default;
    /**
    * Property getter

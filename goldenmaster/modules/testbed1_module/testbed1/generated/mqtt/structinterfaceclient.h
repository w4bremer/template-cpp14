...
namespace Testbed1 {
namespace mqtt {
class TEST_TESTBED1_EXPORT StructInterfaceClient : public IStructInterface, public virtual ApiGear::MQTTImpl::ISink
{
public:
    explicit StructInterfaceClient(std::shared_ptr<ApiGear::MQTTImpl::Client> client);

...
{
    m_client->subscribeTopic(std::string("tb.same1/SameStruct2Interface/prop/prop1"), [this](const std::string& topic, const std::string& args, const std::string&, const std::string&){ onPropertyChanged(topic, args); });
    m_client->subscribeTopic(std::string("tb.same1/SameStruct2Interface/prop/prop2"), [this](const std::string& topic, const std::string& args, const std::string&, const std::string&){ onPropertyChanged(topic, args); });
    m_client->subscribeTopic(std::string("tb.same1/SameStruct2Interface/sig/sig1"), [this](const std::string& topic, const std::string& args, const std::string&, const std::string&){ onSignal(topic, args); });
    m_client->subscribeTopic(std::string("tb.same1/SameStruct2Interface/sig/sig2"), [this](const std::string& topic, const std::string& args, const std::string&, const std::string&){ onSignal(topic, args); });
    m_client->subscribeTopic(std::string("tb.same1/SameStruct2Interface/rpc/func1/"+m_client->getClientId()+"/result"), [this](const std::string&, const std::string& args, const std::string&, const std::string& correlationData){ onInvokeReply(args, correlationData); });
    m_client->subscribeTopic(std::string("tb.same1/SameStruct2Interface/rpc/func2/"+m_client->getClientId()+"/result"), [this](const std::string&, const std::string& args, const std::string&, const std::string& correlationData){ onInvokeReply(args, correlationData); });
}

SameStruct2InterfaceClient::~SameStruct2InterfaceClient()
{
    m_client->unsubscribeTopic(std::string("tb.same1/SameStruct2Interface/prop/prop1"));
    m_client->unsubscribeTopic(std::string("tb.same1/SameStruct2Interface/prop/prop2"));
    m_client->unsubscribeTopic(std::string("tb.same1/SameStruct2Interface/sig/sig1"));
    m_client->unsubscribeTopic(std::string("tb.same1/SameStruct2Interface/sig/sig2"));
    m_client->unsubscribeTopic(std::string("tb.same1/SameStruct2Interface/rpc/func1/"+m_client->getClientId()+"/result"));
    m_client->unsubscribeTopic(std::string("tb.same1/SameStruct2Interface/rpc/func2/"+m_client->getClientId()+"/result"));
}
...
void SameStruct2InterfaceClient::onSignal(const std::string& topic, const std::string& args)
{
...
void SameStruct2InterfaceClient::onPropertyChanged(const std::string& topic, const std::string& args)
{
    nlohmann::json json_args = nlohmann::json::parse(args);

...
namespace {
    ...
    {
        return {
            { std::string("tb.same1/SameEnum2Interface/prop/prop1"), [client](const std::string& args, const std::string&, const std::string&){ client->setProp1Local(args); } },
            { std::string("tb.same1/SameEnum2Interface/prop/prop2"), [client](const std::string& args, const std::string&, const std::string&){ client->setProp2Local(args); } },
            { std::string("tb.same1/SameEnum2Interface/sig/sig1"), [client](const std::string& args, const std::string&, const std::string&){ client->onSig1(args); } },
            { std::string("tb.same1/SameEnum2Interface/sig/sig2"), [client](const std::string& args, const std::string&, const std::string&){ client->onSig2(args); } },
            { std::string("tb.same1/SameEnum2Interface/rpc/func1/"+clientId+"/result"), [client](const std::string& args, const std::string&, const std::string& correlationData){ client->onInvokeReply(args, correlationData); } },
            { std::string("tb.same1/SameEnum2Interface/rpc/func2/"+clientId+"/result"), [client](const std::string& args, const std::string&, const std::string& correlationData){ client->onInvokeReply(args, correlationData); } },
        };
    };
}
...
void SameEnum2InterfaceClient::setProp1Local(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    Enum1Enum prop1 = fields["prop1"].get<Enum1Enum>();
...
void SameEnum2InterfaceClient::setProp2Local(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    Enum2Enum prop2 = fields["prop2"].get<Enum2Enum>();

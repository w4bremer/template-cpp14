...
{
    m_client->subscribeTopic(std::string("tb.same1/SameStruct1Interface/prop/prop1"), [this](const std::string& topic, const std::string& args, const std::string&, const std::string&){ onPropertyChanged(topic, args); });
    m_client->subscribeTopic(std::string("tb.same1/SameStruct1Interface/sig/sig1"), [this](const std::string& topic, const std::string& args, const std::string&, const std::string&){ onSignal(topic, args); });
    m_client->subscribeTopic(std::string("tb.same1/SameStruct1Interface/rpc/func1/"+m_client->getClientId()+"/result"), [this](const std::string&, const std::string& args, const std::string&, const std::string& correlationData){ onInvokeReply(args, correlationData); });
}

SameStruct1InterfaceClient::~SameStruct1InterfaceClient()
{
    m_client->unsubscribeTopic(std::string("tb.same1/SameStruct1Interface/prop/prop1"));
    m_client->unsubscribeTopic(std::string("tb.same1/SameStruct1Interface/sig/sig1"));
    m_client->unsubscribeTopic(std::string("tb.same1/SameStruct1Interface/rpc/func1/"+m_client->getClientId()+"/result"));
}
...
void SameStruct1InterfaceClient::onSignal(const std::string& topic, const std::string& args)
{
...
void SameStruct1InterfaceClient::onPropertyChanged(const std::string& topic, const std::string& args)
{
    nlohmann::json json_args = nlohmann::json::parse(args);

    ...
    , m_service(service)
{
    ...
    m_service->subscribeTopic(ApiGear::MQTT::Topic("tb.same1","SameEnum1Interface",ApiGear::MQTT::Topic::TopicType::Operation,"_setprop1"), this);
    m_service->subscribeTopic(ApiGear::MQTT::Topic("tb.same1","SameEnum1Interface",ApiGear::MQTT::Topic::TopicType::Operation,"func1"), this);
...
SameEnum1InterfaceService::~SameEnum1InterfaceService()
{
    ...
    m_service->unsubscribeTopic(ApiGear::MQTT::Topic("tb.same1","SameEnum1Interface",ApiGear::MQTT::Topic::TopicType::Operation,"_setprop1"), this);
    m_service->unsubscribeTopic(ApiGear::MQTT::Topic("tb.same1","SameEnum1Interface",ApiGear::MQTT::Topic::TopicType::Operation,"func1"), this);
}

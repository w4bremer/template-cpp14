    ...
    , m_service(service)
{
    ...
    m_service->subscribeTopic(std::string("tb.same1/SameStruct1Interface/set/prop1"), [this](const std::string& topic, const std::string& args, const std::string&, const std::string&){ onSetProperty(topic, args); });
    m_service->subscribeTopic(std::string("tb.same1/SameStruct1Interface/rpc/func1"), [this](const std::string& topic, const std::string& args, const std::string& responseTopic, const std::string& correlationData) { onInvoke(topic, args, responseTopic, correlationData); });
...
SameStruct1InterfaceService::~SameStruct1InterfaceService()
{
    ...
    m_service->unsubscribeTopic(std::string("tb.same1/SameStruct1Interface/set/prop1"));
    m_service->unsubscribeTopic(std::string("tb.same1/SameStruct1Interface/rpc/func1"));
}

    ...
    , m_service(service)
{
    ...
    m_service->subscribeTopic(std::string("tb.same1/SameStruct1Interface/set/prop1"), std::bind(&SameStruct1InterfaceService::onSetProperty, this, std::placeholders::_1, std::placeholders::_2));
    m_service->subscribeTopic(std::string("tb.same1/SameStruct1Interface/rpc/func1"), std::bind(&SameStruct1InterfaceService::onInvoke, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));
...
SameStruct1InterfaceService::~SameStruct1InterfaceService()
{
    ...
    m_service->unsubscribeTopic(std::string("tb.same1/SameStruct1Interface/set/prop1"), std::bind(&SameStruct1InterfaceService::onSetProperty, this, std::placeholders::_1, std::placeholders::_2));
    m_service->unsubscribeTopic(std::string("tb.same1/SameStruct1Interface/rpc/func1"), std::bind(&SameStruct1InterfaceService::onInvoke, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));
}

...
namespace TbSame1 {
namespace mqtt {
class TEST_TB_SAME1_EXPORT SameEnum2InterfaceService : public virtual ApiGear::MQTTImpl::ISink, public ISameEnum2InterfaceSubscriber
{
public:
    explicit SameEnum2InterfaceService(std::shared_ptr<ISameEnum2Interface> impl, std::shared_ptr<ApiGear::MQTTImpl::Client> client);

...
{
    m_client->subscribeTopic(std::string("tb.same1/SameEnum1Interface/prop/prop1"), [this](const std::string& topic, const std::string& args, const std::string&, const std::string&){ onPropertyChanged(topic, args, "", ""); });
    m_client->subscribeTopic(std::string("tb.same1/SameEnum1Interface/sig/sig1"), [this](const std::string& topic, const std::string& args, const std::string&, const std::string&){ onSignal(topic, args, "", ""); });
    m_client->subscribeTopic(std::string("tb.same1/SameEnum1Interface/rpc/func1/"+m_client->getClientId()+"/result"), [this](const std::string&, const std::string& args, const std::string&, const std::string& correlationData){ onInvokeReply("", args, "", correlationData); });
}

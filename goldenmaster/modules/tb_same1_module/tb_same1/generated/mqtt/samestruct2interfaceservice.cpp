...
{
    return {
        {std::string("tb.same1/SameStruct2Interface/set/prop1"), [this](const std::string& args, const std::string&, const std::string&){ this->onSetProp1(args); } },
        {std::string("tb.same1/SameStruct2Interface/set/prop2"), [this](const std::string& args, const std::string&, const std::string&){ this->onSetProp2(args); } },
        {std::string("tb.same1/SameStruct2Interface/rpc/func1"), [this](const std::string& args, const std::string& responseTopic, const std::string& correlationData) { this->onInvokeFunc1(args, responseTopic, correlationData); } },
        {std::string("tb.same1/SameStruct2Interface/rpc/func2"), [this](const std::string& args, const std::string& responseTopic, const std::string& correlationData) { this->onInvokeFunc2(args, responseTopic, correlationData); } },
    };
}
...
void SameStruct2InterfaceService::onInvokeFunc1(const std::string& args, const std::string& responseTopic, const std::string& correlationData) const
{
    ...
    {
        responseTopicReturn = std::string("tb.same1/SameStruct2Interface/rpc/func1/" + json_args.at(1).get<std::string>() + "/result");
    }
    int responseId = 0;
    ...
    const Struct1& param1 = payload.at(0).get<Struct1>();
...
void SameStruct2InterfaceService::onInvokeFunc2(const std::string& args, const std::string& responseTopic, const std::string& correlationData) const
{
    ...
    if (responseTopicReturn.empty())
    {
        responseTopicReturn = std::string("tb.same1/SameStruct2Interface/rpc/func2/" + json_args.at(1).get<std::string>() + "/result");
    }
    int responseId = 0;
    if (correlationData.empty())
    {
    ...
    nlohmann::json payload = json_args.at(2);
    const Struct1& param1 = payload.at(0).get<Struct1>();
    const Struct2& param2 = payload.at(1).get<Struct2>();

...
namespace {
    std::map<std::string, ApiGear::MQTT::CallbackFunction> createTopicMap(SameStruct2InterfaceService* service)
    {
        return {
            ...
            {std::string("tb.same1/SameStruct2Interface/rpc/func1"), [service](const std::string&, const std::string& args, const std::string& responseTopic, const std::string& correlationData) { service->onInvokeFunc1(args, responseTopic, correlationData); } },
            {std::string("tb.same1/SameStruct2Interface/rpc/func2"), [service](const std::string&, const std::string& args, const std::string& responseTopic, const std::string& correlationData) { service->onInvokeFunc2(args, responseTopic, correlationData); } },
        };
    };
}

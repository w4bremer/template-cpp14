...
namespace {
    ...
    {
        return {
            {std::string("tb.same1/SameStruct2Interface/set/prop1"), [service](const std::string&, const std::string& args, const std::string&, const std::string&){ service->onSetProp1(args); } },
            {std::string("tb.same1/SameStruct2Interface/set/prop2"), [service](const std::string&, const std::string& args, const std::string&, const std::string&){ service->onSetProp2(args); } },

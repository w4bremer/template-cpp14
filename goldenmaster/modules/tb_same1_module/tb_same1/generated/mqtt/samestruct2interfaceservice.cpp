    ...
    , m_service(service)
{
    ...
    m_service->subscribeTopic(ApiGear::MQTT::Topic("tb.same1","SameStruct2Interface",ApiGear::MQTT::Topic::TopicType::Operation,"_setprop1"), this);
    m_service->subscribeTopic(ApiGear::MQTT::Topic("tb.same1","SameStruct2Interface",ApiGear::MQTT::Topic::TopicType::Operation,"_setprop2"), this);
    m_service->subscribeTopic(ApiGear::MQTT::Topic("tb.same1","SameStruct2Interface",ApiGear::MQTT::Topic::TopicType::Operation,"func1"), this);
    m_service->subscribeTopic(ApiGear::MQTT::Topic("tb.same1","SameStruct2Interface",ApiGear::MQTT::Topic::TopicType::Operation,"func2"), this);
...
SameStruct2InterfaceService::~SameStruct2InterfaceService()
{
    ...
    m_service->unsubscribeTopic(ApiGear::MQTT::Topic("tb.same1","SameStruct2Interface",ApiGear::MQTT::Topic::TopicType::Operation,"_setprop1"), this);
    m_service->unsubscribeTopic(ApiGear::MQTT::Topic("tb.same1","SameStruct2Interface",ApiGear::MQTT::Topic::TopicType::Operation,"_setprop2"), this);
    m_service->unsubscribeTopic(ApiGear::MQTT::Topic("tb.same1","SameStruct2Interface",ApiGear::MQTT::Topic::TopicType::Operation,"func1"), this);
    m_service->unsubscribeTopic(ApiGear::MQTT::Topic("tb.same1","SameStruct2Interface",ApiGear::MQTT::Topic::TopicType::Operation,"func2"), this);
}

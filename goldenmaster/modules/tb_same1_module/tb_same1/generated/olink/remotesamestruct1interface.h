...
namespace olink {
/**
* The class for handling connetion witha a SameStruct1Interface service implemented for OLink protocol. 
...
*/
class TEST_TB_SAME1_EXPORT RemoteSameStruct1Interface : public ISameStruct1Interface,
...
public:
    ...
    */
    explicit RemoteSameStruct1Interface(std::weak_ptr<ApiGear::PocoImpl::IOlinkConnector> olinkConnector);
    ...
    */
    ...
    /**
    * Informs if the remote RemoteSameStruct1Interface is ready to send and revice messages.
...
private:
    ...
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the RemoteSameStruct1Interface.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;
    /**
    * A helper used to connect with a Olink SameStruct1Interface service for object given with olinkObjectName()
    * takes care of setup and tear down linkage for this RemoteSameStruct1Interface.
    */

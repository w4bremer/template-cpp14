...
*     It provides a network implementation and tools to connect RemoteSameStruct1Interface to it.
...
public:
    ...
    /** ctor */
    explicit RemoteSameStruct1Interface();
    /** dtor */
    virtual ~RemoteSameStruct1Interface() = default;
    /**
    * Property getter

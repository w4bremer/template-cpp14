...
namespace olink {
/**
* Adapts the general OLink Client handler to a ManyParamInterface publisher in a way it provides access 
* to remote ManyParamInterface services. 
...
*     It provides a network implementation and tools to connect ManyParamInterfaceClient to it.
...
public:
    ...
    /** ctor */
    explicit ManyParamInterfaceClient();
    /** dtor */
    virtual ~ManyParamInterfaceClient() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Informs if the ManyParamInterfaceClient is ready to send and receive messages.
...
private:
    ...
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the ManyParamInterfaceClient.

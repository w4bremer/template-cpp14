...
namespace Testbed2 {
namespace mqtt {
class TEST_TESTBED2_EXPORT ManyParamInterfaceClient : public IManyParamInterface, public virtual ApiGear::MQTTImpl::ISink
{
public:
    explicit ManyParamInterfaceClient(std::shared_ptr<ApiGear::MQTTImpl::Client> client);

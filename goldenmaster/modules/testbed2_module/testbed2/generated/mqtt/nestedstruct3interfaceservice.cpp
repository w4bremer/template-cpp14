...
void NestedStruct3InterfaceService::onInvokeFunc1(const std::string& args, const std::string& responseTopic, const std::string& correlationData) const
{
    ...
    {
        responseTopicReturn = std::string("testbed2/NestedStruct3Interface/rpc/func1/" + json_args.at(1).get<std::string>() + "/result");
    }
    int responseId = 0;
...
void NestedStruct3InterfaceService::onInvokeFunc2(const std::string& args, const std::string& responseTopic, const std::string& correlationData) const
{
    ...
    if (responseTopicReturn.empty())
    {
        responseTopicReturn = std::string("testbed2/NestedStruct3Interface/rpc/func2/" + json_args.at(1).get<std::string>() + "/result");
    }
    int responseId = 0;
    if (correlationData.empty())
    {
...
void NestedStruct3InterfaceService::onInvokeFunc3(const std::string& args, const std::string& responseTopic, const std::string& correlationData) const
{
    ...
    if (responseTopicReturn.empty())
    {
        responseTopicReturn = std::string("testbed2/NestedStruct3Interface/rpc/func3/" + json_args.at(1).get<std::string>() + "/result");
    }
    int responseId = 0;
    if (correlationData.empty())
    {
    ...
    const NestedStruct1& param1 = payload.at(0).get<NestedStruct1>();
    const NestedStruct2& param2 = payload.at(1).get<NestedStruct2>();
    const NestedStruct3& param3 = payload.at(2).get<NestedStruct3>();

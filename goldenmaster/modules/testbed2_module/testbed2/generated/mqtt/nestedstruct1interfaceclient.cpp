...
namespace {
    ...
    {
        return {
            { std::string("testbed2/NestedStruct1Interface/prop/prop1"), [client](const std::string& args, const std::string&, const std::string&){ client->setProp1Local(args); } },
            { std::string("testbed2/NestedStruct1Interface/sig/sig1"), [client](const std::string& args, const std::string&, const std::string&){ client->onSig1(args); } },
            { std::string("testbed2/NestedStruct1Interface/rpc/func1/"+clientId+"/result"), [client](const std::string& args, const std::string&, const std::string& correlationData){ client->onInvokeReply(args, correlationData); } },
        };
    };
}
...
void NestedStruct1InterfaceClient::setProp1Local(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;

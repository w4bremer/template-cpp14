    ...
    , m_client(client)
{
    ...
    m_client->subscribeTopic(ApiGear::MQTTImpl::Topic("testbed2","NestedStruct2Interface",ApiGear::MQTTImpl::Topic::TopicType::Operation,"_setprop1"), this);
    m_client->subscribeTopic(ApiGear::MQTTImpl::Topic("testbed2","NestedStruct2Interface",ApiGear::MQTTImpl::Topic::TopicType::Operation,"_setprop2"), this);
    m_client->subscribeTopic(ApiGear::MQTTImpl::Topic("testbed2","NestedStruct2Interface",ApiGear::MQTTImpl::Topic::TopicType::Operation,"func1"), this);
    m_client->subscribeTopic(ApiGear::MQTTImpl::Topic("testbed2","NestedStruct2Interface",ApiGear::MQTTImpl::Topic::TopicType::Operation,"func2"), this);
...
NestedStruct2InterfaceService::~NestedStruct2InterfaceService()
{
    ...
    m_client->unsubscribeTopic(ApiGear::MQTTImpl::Topic("testbed2","NestedStruct2Interface",ApiGear::MQTTImpl::Topic::TopicType::Operation,"_setprop2"), this);
    m_client->unsubscribeTopic(ApiGear::MQTTImpl::Topic("testbed2","NestedStruct2Interface",ApiGear::MQTTImpl::Topic::TopicType::Operation,"func1"), this);
    m_client->unsubscribeTopic(ApiGear::MQTTImpl::Topic("testbed2","NestedStruct2Interface",ApiGear::MQTTImpl::Topic::TopicType::Operation,"func2"), this);
}
...
void NestedStruct2InterfaceService::onSig1(const NestedStruct1& param1)
{
    if(m_client != nullptr) {
        ...
        static const auto topic = ApiGear::MQTTImpl::Topic("testbed2","NestedStruct2Interface",ApiGear::MQTTImpl::Topic::TopicType::Signal,"sig1");
...
void NestedStruct2InterfaceService::onSig2(const NestedStruct1& param1, const NestedStruct2& param2)
{
    if(m_client != nullptr) {
        ...
        static const auto topic = ApiGear::MQTTImpl::Topic("testbed2","NestedStruct2Interface",ApiGear::MQTTImpl::Topic::TopicType::Signal,"sig2");
        m_client->notifySignal(topic, nlohmann::json(args).dump());
    }
}
...
{
    if(m_client != nullptr) {
        static const auto topic = ApiGear::MQTTImpl::Topic("testbed2","NestedStruct2Interface",ApiGear::MQTTImpl::Topic::TopicType::Property,"prop1");
...
{
    if(m_client != nullptr) {
        static const auto topic = ApiGear::MQTTImpl::Topic("testbed2","NestedStruct2Interface",ApiGear::MQTTImpl::Topic::TopicType::Property,"prop2");

...
#include "testbed2_nestedstruct3interfaceinterface.h"

#include "generated/core/testbed2.json.adapter.h"

using namespace Test::Testbed2;

OLinkNestedStruct3Interface::OLinkNestedStruct3Interface(ApiGear::ObjectLink::ClientRegistry& registry, ApiGear::PocoImpl::OLinkClient& client)
    : m_isReady(false)
    ...
    , m_node(nullptr)
    , m_registry(&registry)
    , m_publisher(new NestedStruct3InterfacePublisher())
{
...
const NestedStruct1& OLinkNestedStruct3Interface::prop1() const
{
    return m_prop1;
}
...
const NestedStruct2& OLinkNestedStruct3Interface::prop2() const
{
    return m_prop2;
}
...
const NestedStruct3& OLinkNestedStruct3Interface::prop3() const
{
    return m_prop3;
}
...
std::future<NestedStruct1> OLinkNestedStruct3Interface::func1Async(const NestedStruct1& param1)
{
    if(m_node == nullptr) {
...
std::future<NestedStruct1> OLinkNestedStruct3Interface::func2Async(const NestedStruct1& param1, const NestedStruct2& param2)
{
    if(m_node == nullptr) {
        throw std::runtime_error("Node is not initialized");
    }
...
std::future<NestedStruct1> OLinkNestedStruct3Interface::func3Async(const NestedStruct1& param1, const NestedStruct2& param2, const NestedStruct3& param3)
{
    if(m_node == nullptr) {
        throw std::runtime_error("Node is not initialized");
    }
...
void OLinkNestedStruct3Interface::olinkOnSignal(std::string name, nlohmann::json args)
{
...
void OLinkNestedStruct3Interface::olinkOnPropertyChanged(std::string name, nlohmann::json value)
{
    std::string path = ApiGear::ObjectLink::Name::pathFromName(name);
    applyState({ {path, value} });
}
void OLinkNestedStruct3Interface::olinkOnInit(std::string name, nlohmann::json props, ApiGear::ObjectLink::IClientNode *node)
{
    (void) name;
    m_isReady = true;
    m_node = node;
...
bool OLinkNestedStruct3Interface::isReady() const
{
    return m_isReady;
}

INestedStruct3InterfacePublisher* OLinkNestedStruct3Interface::_getPublisher() const
{
    return m_publisher;
}

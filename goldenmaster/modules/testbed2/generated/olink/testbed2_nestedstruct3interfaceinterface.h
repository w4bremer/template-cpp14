...
namespace Test {
namespace Testbed2 {
class TEST_TESTBED2_EXPORT OLinkNestedStruct3Interface : public INestedStruct3Interface, public ApiGear::ObjectLink::IObjectSink
{
public:
    explicit OLinkNestedStruct3Interface(ApiGear::ObjectLink::ClientRegistry& registry, ApiGear::PocoImpl::OLinkClient& client);
...
private:
    ...
    INestedStruct3InterfacePublisher* m_publisher;
};
} // namespace Testbed2
} // namespace Test

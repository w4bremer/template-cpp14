...
namespace {
    ...
    {
        return {
            { std::string("tb.simple/SimpleInterface/prop/propBool"), [client](const std::string& args, const std::string&, const std::string&){ client->setPropBoolLocal(args); } },
            { std::string("tb.simple/SimpleInterface/prop/propInt"), [client](const std::string& args, const std::string&, const std::string&){ client->setPropIntLocal(args); } },
            { std::string("tb.simple/SimpleInterface/prop/propInt32"), [client](const std::string& args, const std::string&, const std::string&){ client->setPropInt32Local(args); } },
            { std::string("tb.simple/SimpleInterface/prop/propInt64"), [client](const std::string& args, const std::string&, const std::string&){ client->setPropInt64Local(args); } },
            { std::string("tb.simple/SimpleInterface/prop/propFloat"), [client](const std::string& args, const std::string&, const std::string&){ client->setPropFloatLocal(args); } },
            { std::string("tb.simple/SimpleInterface/prop/propFloat32"), [client](const std::string& args, const std::string&, const std::string&){ client->setPropFloat32Local(args); } },
            { std::string("tb.simple/SimpleInterface/prop/propFloat64"), [client](const std::string& args, const std::string&, const std::string&){ client->setPropFloat64Local(args); } },
            { std::string("tb.simple/SimpleInterface/prop/propString"), [client](const std::string& args, const std::string&, const std::string&){ client->setPropStringLocal(args); } },
            { std::string("tb.simple/SimpleInterface/sig/sigBool"), [client](const std::string& args, const std::string&, const std::string&){ client->onSigBool(args); } },
            { std::string("tb.simple/SimpleInterface/sig/sigInt"), [client](const std::string& args, const std::string&, const std::string&){ client->onSigInt(args); } },
            { std::string("tb.simple/SimpleInterface/sig/sigInt32"), [client](const std::string& args, const std::string&, const std::string&){ client->onSigInt32(args); } },
            { std::string("tb.simple/SimpleInterface/sig/sigInt64"), [client](const std::string& args, const std::string&, const std::string&){ client->onSigInt64(args); } },
            { std::string("tb.simple/SimpleInterface/sig/sigFloat"), [client](const std::string& args, const std::string&, const std::string&){ client->onSigFloat(args); } },
            { std::string("tb.simple/SimpleInterface/sig/sigFloat32"), [client](const std::string& args, const std::string&, const std::string&){ client->onSigFloat32(args); } },
            { std::string("tb.simple/SimpleInterface/sig/sigFloat64"), [client](const std::string& args, const std::string&, const std::string&){ client->onSigFloat64(args); } },
            { std::string("tb.simple/SimpleInterface/sig/sigString"), [client](const std::string& args, const std::string&, const std::string&){ client->onSigString(args); } },
            { std::string("tb.simple/SimpleInterface/rpc/funcBool/"+clientId+"/result"), [client](const std::string& args, const std::string&, const std::string& correlationData){ client->onInvokeReply(args, correlationData); } },
            { std::string("tb.simple/SimpleInterface/rpc/funcInt/"+clientId+"/result"), [client](const std::string& args, const std::string&, const std::string& correlationData){ client->onInvokeReply(args, correlationData); } },
            { std::string("tb.simple/SimpleInterface/rpc/funcInt32/"+clientId+"/result"), [client](const std::string& args, const std::string&, const std::string& correlationData){ client->onInvokeReply(args, correlationData); } },
            { std::string("tb.simple/SimpleInterface/rpc/funcInt64/"+clientId+"/result"), [client](const std::string& args, const std::string&, const std::string& correlationData){ client->onInvokeReply(args, correlationData); } },
            { std::string("tb.simple/SimpleInterface/rpc/funcFloat/"+clientId+"/result"), [client](const std::string& args, const std::string&, const std::string& correlationData){ client->onInvokeReply(args, correlationData); } },
            { std::string("tb.simple/SimpleInterface/rpc/funcFloat32/"+clientId+"/result"), [client](const std::string& args, const std::string&, const std::string& correlationData){ client->onInvokeReply(args, correlationData); } },
            { std::string("tb.simple/SimpleInterface/rpc/funcFloat64/"+clientId+"/result"), [client](const std::string& args, const std::string&, const std::string& correlationData){ client->onInvokeReply(args, correlationData); } },
            { std::string("tb.simple/SimpleInterface/rpc/funcString/"+clientId+"/result"), [client](const std::string& args, const std::string&, const std::string& correlationData){ client->onInvokeReply(args, correlationData); } },
        };
    };
}
...
void SimpleInterfaceClient::setPropBoolLocal(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    bool propBool = fields["propBool"].get<bool>();
...
void SimpleInterfaceClient::setPropIntLocal(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    int propInt = fields["propInt"].get<int>();
...
void SimpleInterfaceClient::setPropInt32Local(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    int32_t propInt32 = fields["propInt32"].get<int32_t>();
...
void SimpleInterfaceClient::setPropInt64Local(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    int64_t propInt64 = fields["propInt64"].get<int64_t>();
...
void SimpleInterfaceClient::setPropFloatLocal(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    float propFloat = fields["propFloat"].get<float>();
...
void SimpleInterfaceClient::setPropFloat32Local(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    float propFloat32 = fields["propFloat32"].get<float>();
...
void SimpleInterfaceClient::setPropFloat64Local(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    double propFloat64 = fields["propFloat64"].get<double>();
...
void SimpleInterfaceClient::setPropStringLocal(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    const std::string& propString = fields["propString"].get<std::string>();

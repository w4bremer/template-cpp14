...
namespace {
    ...
    {
        return {
            { std::string("tb.simple/SimpleArrayInterface/prop/propBool"), [client](const std::string&, const std::string& args, const std::string&, const std::string&){ client->setPropBoolLocal(args); } },
            { std::string("tb.simple/SimpleArrayInterface/prop/propInt"), [client](const std::string&, const std::string& args, const std::string&, const std::string&){ client->setPropIntLocal(args); } },
            { std::string("tb.simple/SimpleArrayInterface/prop/propInt32"), [client](const std::string&, const std::string& args, const std::string&, const std::string&){ client->setPropInt32Local(args); } },
            { std::string("tb.simple/SimpleArrayInterface/prop/propInt64"), [client](const std::string&, const std::string& args, const std::string&, const std::string&){ client->setPropInt64Local(args); } },
            { std::string("tb.simple/SimpleArrayInterface/prop/propFloat"), [client](const std::string&, const std::string& args, const std::string&, const std::string&){ client->setPropFloatLocal(args); } },
            { std::string("tb.simple/SimpleArrayInterface/prop/propFloat32"), [client](const std::string&, const std::string& args, const std::string&, const std::string&){ client->setPropFloat32Local(args); } },
            { std::string("tb.simple/SimpleArrayInterface/prop/propFloat64"), [client](const std::string&, const std::string& args, const std::string&, const std::string&){ client->setPropFloat64Local(args); } },
            { std::string("tb.simple/SimpleArrayInterface/prop/propString"), [client](const std::string&, const std::string& args, const std::string&, const std::string&){ client->setPropStringLocal(args); } },
            { std::string("tb.simple/SimpleArrayInterface/sig/sigBool"), [client](const std::string& topic, const std::string& args, const std::string&, const std::string&){ client->onSignal(topic, args); } },
            { std::string("tb.simple/SimpleArrayInterface/sig/sigInt"), [client](const std::string& topic, const std::string& args, const std::string&, const std::string&){ client->onSignal(topic, args); } },
            { std::string("tb.simple/SimpleArrayInterface/sig/sigInt32"), [client](const std::string& topic, const std::string& args, const std::string&, const std::string&){ client->onSignal(topic, args); } },
            { std::string("tb.simple/SimpleArrayInterface/sig/sigInt64"), [client](const std::string& topic, const std::string& args, const std::string&, const std::string&){ client->onSignal(topic, args); } },
            { std::string("tb.simple/SimpleArrayInterface/sig/sigFloat"), [client](const std::string& topic, const std::string& args, const std::string&, const std::string&){ client->onSignal(topic, args); } },
            { std::string("tb.simple/SimpleArrayInterface/sig/sigFloat32"), [client](const std::string& topic, const std::string& args, const std::string&, const std::string&){ client->onSignal(topic, args); } },
            { std::string("tb.simple/SimpleArrayInterface/sig/sigFloat64"), [client](const std::string& topic, const std::string& args, const std::string&, const std::string&){ client->onSignal(topic, args); } },
            { std::string("tb.simple/SimpleArrayInterface/sig/sigString"), [client](const std::string& topic, const std::string& args, const std::string&, const std::string&){ client->onSignal(topic, args); } },
            { std::string("tb.simple/SimpleArrayInterface/rpc/funcBool/"+clientId+"/result"), [client](const std::string&, const std::string& args, const std::string&, const std::string& correlationData){ client->onInvokeReply(args, correlationData); } },
            { std::string("tb.simple/SimpleArrayInterface/rpc/funcInt/"+clientId+"/result"), [client](const std::string&, const std::string& args, const std::string&, const std::string& correlationData){ client->onInvokeReply(args, correlationData); } },
            { std::string("tb.simple/SimpleArrayInterface/rpc/funcInt32/"+clientId+"/result"), [client](const std::string&, const std::string& args, const std::string&, const std::string& correlationData){ client->onInvokeReply(args, correlationData); } },
            { std::string("tb.simple/SimpleArrayInterface/rpc/funcInt64/"+clientId+"/result"), [client](const std::string&, const std::string& args, const std::string&, const std::string& correlationData){ client->onInvokeReply(args, correlationData); } },
            { std::string("tb.simple/SimpleArrayInterface/rpc/funcFloat/"+clientId+"/result"), [client](const std::string&, const std::string& args, const std::string&, const std::string& correlationData){ client->onInvokeReply(args, correlationData); } },
            { std::string("tb.simple/SimpleArrayInterface/rpc/funcFloat32/"+clientId+"/result"), [client](const std::string&, const std::string& args, const std::string&, const std::string& correlationData){ client->onInvokeReply(args, correlationData); } },
            { std::string("tb.simple/SimpleArrayInterface/rpc/funcFloat64/"+clientId+"/result"), [client](const std::string&, const std::string& args, const std::string&, const std::string& correlationData){ client->onInvokeReply(args, correlationData); } },
            { std::string("tb.simple/SimpleArrayInterface/rpc/funcString/"+clientId+"/result"), [client](const std::string&, const std::string& args, const std::string&, const std::string& correlationData){ client->onInvokeReply(args, correlationData); } },
        };
    };
}
...
void SimpleArrayInterfaceClient::setPropBoolLocal(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    const std::list<bool>& propBool = fields["propBool"].get<std::list<bool>>();
...
void SimpleArrayInterfaceClient::setPropIntLocal(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    const std::list<int>& propInt = fields["propInt"].get<std::list<int>>();
...
void SimpleArrayInterfaceClient::setPropInt32Local(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    const std::list<int32_t>& propInt32 = fields["propInt32"].get<std::list<int32_t>>();
...
void SimpleArrayInterfaceClient::setPropInt64Local(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    const std::list<int64_t>& propInt64 = fields["propInt64"].get<std::list<int64_t>>();
...
void SimpleArrayInterfaceClient::setPropFloatLocal(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    const std::list<float>& propFloat = fields["propFloat"].get<std::list<float>>();
...
void SimpleArrayInterfaceClient::setPropFloat32Local(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    const std::list<float>& propFloat32 = fields["propFloat32"].get<std::list<float>>();
...
void SimpleArrayInterfaceClient::setPropFloat64Local(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    const std::list<double>& propFloat64 = fields["propFloat64"].get<std::list<double>>();
...
void SimpleArrayInterfaceClient::setPropStringLocal(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    const std::list<std::string>& propString = fields["propString"].get<std::list<std::string>>();
...
void SimpleArrayInterfaceClient::onSignal(const std::string& topic, const std::string& args)
{

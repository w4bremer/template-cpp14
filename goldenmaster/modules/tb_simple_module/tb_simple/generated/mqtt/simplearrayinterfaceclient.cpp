...
namespace {
    ...
    {
        return {
            { std::string("tb.simple/SimpleArrayInterface/prop/propBool"), [client](const std::string& topic, const std::string& args, const std::string&, const std::string&){ client->onPropertyChanged(topic, args); } },
            { std::string("tb.simple/SimpleArrayInterface/prop/propInt"), [client](const std::string& topic, const std::string& args, const std::string&, const std::string&){ client->onPropertyChanged(topic, args); } },
            { std::string("tb.simple/SimpleArrayInterface/prop/propInt32"), [client](const std::string& topic, const std::string& args, const std::string&, const std::string&){ client->onPropertyChanged(topic, args); } },
            { std::string("tb.simple/SimpleArrayInterface/prop/propInt64"), [client](const std::string& topic, const std::string& args, const std::string&, const std::string&){ client->onPropertyChanged(topic, args); } },
            { std::string("tb.simple/SimpleArrayInterface/prop/propFloat"), [client](const std::string& topic, const std::string& args, const std::string&, const std::string&){ client->onPropertyChanged(topic, args); } },
            { std::string("tb.simple/SimpleArrayInterface/prop/propFloat32"), [client](const std::string& topic, const std::string& args, const std::string&, const std::string&){ client->onPropertyChanged(topic, args); } },
            { std::string("tb.simple/SimpleArrayInterface/prop/propFloat64"), [client](const std::string& topic, const std::string& args, const std::string&, const std::string&){ client->onPropertyChanged(topic, args); } },
            { std::string("tb.simple/SimpleArrayInterface/prop/propString"), [client](const std::string& topic, const std::string& args, const std::string&, const std::string&){ client->onPropertyChanged(topic, args); } },

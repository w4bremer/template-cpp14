...
void NoOperationsInterfaceClient::setPropBoolLocal(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
...
void NoOperationsInterfaceClient::setPropIntLocal(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;

...
*/
class TEST_TB_SIMPLE_EXPORT VoidInterfaceService : public ApiGear::ObjectLink::IObjectSource, public IVoidInterfaceSubscriber
{
public:
    /**
    * ctor
    * @param VoidInterface The service source object, the actual VoidInterface object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit VoidInterfaceService(std::shared_ptr<IVoidInterface> VoidInterface, ApiGear::ObjectLink::RemoteRegistry& registry);
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the VoidInterface object.
...
private:
    /**
    * The VoidInterface used for object source.
    */
    std::shared_ptr<IVoidInterface> m_VoidInterface;
    /**

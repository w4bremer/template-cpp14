...
*     It provides a network implementation and tools to connect RemoteSimpleArrayInterface to it.
...
public:
    ...
    /** ctor */
    explicit RemoteSimpleArrayInterface();
    /** dtor */
    virtual ~RemoteSimpleArrayInterface() = default;
    /**
    * Property getter

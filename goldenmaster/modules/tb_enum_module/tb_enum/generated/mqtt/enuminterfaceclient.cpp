...
void EnumInterfaceClient::setProp0Local(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    Enum0Enum prop0 = fields["prop0"].get<Enum0Enum>();
...
void EnumInterfaceClient::setProp1Local(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
...
void EnumInterfaceClient::setProp2Local(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
...
void EnumInterfaceClient::setProp3Local(const nlohmann::json& fields)
{
    if (fields.empty())
    {
        return;
    ...
    Enum3Enum prop3 = fields["prop3"].get<Enum3Enum>();

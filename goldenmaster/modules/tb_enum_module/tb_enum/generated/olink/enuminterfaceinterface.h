...
namespace Test {
namespace TbEnum {
class TEST_TB_ENUM_EXPORT OLinkEnumInterface : public IEnumInterface, public ApiGear::ObjectLink::IObjectSink
{
public:
    explicit OLinkEnumInterface(ApiGear::ObjectLink::ClientRegistry& registry, ApiGear::PocoImpl::OLinkClient& client);
...
private:
    ...
    IEnumInterfacePublisher* m_publisher;
};
} // namespace TbEnum
} // namespace Test

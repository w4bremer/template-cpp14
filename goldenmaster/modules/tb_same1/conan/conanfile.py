...
class tb_same1Conan(ConanFile):
    ...
    def generate(self):
        ...
        tc.cache_variables['TB_SAME1_FETCH_OLINKCORE'] = self.options.enable_fetch_olinkcore
    ...
    def package_info(self):
        ...
        self.cpp_info.components["tb_same1-implementation"].requires = ["tb_same1-core", "nlohmann_json::nlohmann_json"]

...
#include "generated/core/tb_same1_sameenum1interface.publisher.h"

namespace Test {
namespace TbSame1 {

class TEST_TB_SAME1_EXPORT AbstractSameEnum1InterfaceDecorator : public ISameEnum1InterfaceDecorator
{
public:

...
void SameEnum2InterfaceTracer::trace_func1(Enum1Enum param1)
{
    nlohmann::json fields_;
...
void SameEnum2InterfaceTracer::trace_func2(Enum1Enum param1, Enum2Enum param2)
{
    nlohmann::json fields_;
    fields_["param1"] = param1;
...
void SameEnum2InterfaceTracer::trace_sig1(Enum1Enum param1)
{
    nlohmann::json fields_;
    fields_["param1"] = param1;
    m_tracer.signal("tb.same1.SameEnum2Interface#sig1", fields_);
}
void SameEnum2InterfaceTracer::trace_sig2(Enum1Enum param1, Enum2Enum param2)
{
    nlohmann::json fields_;
    fields_["param1"] = param1;
    fields_["param2"] = param2;

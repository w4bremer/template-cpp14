...
class TEST_ORG_OBJECTAPI_TESTBED_EXPORT AbstractInterface2Decorator : public IInterface2Decorator
{
public:
    explicit AbstractInterface2Decorator(IInterface2* impl);
    IInterface2* swapUnderlyingImplementation(IInterface2* impl) override;
    IInterface2* disconnectFromUnderlyingImplementation() override;
    virtual ~AbstractInterface2Decorator();
public:
    // property prop200

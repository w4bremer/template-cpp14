...
namespace TbSame2 {
namespace mqtt {
class TEST_TB_SAME2_EXPORT SameEnum2InterfaceClient : public ISameEnum2Interface, public virtual ApiGear::MQTTImpl::ISink
{
public:
    explicit SameEnum2InterfaceClient(std::shared_ptr<ApiGear::MQTTImpl::Client> client);

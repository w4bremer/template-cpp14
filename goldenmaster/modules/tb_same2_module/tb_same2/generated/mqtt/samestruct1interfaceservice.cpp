    ...
    , m_client(client)
{
    ...
    m_client->subscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameStruct1Interface",ApiGear::MQTT::Topic::TopicType::Operation,"_setprop1"), this);
    m_client->subscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameStruct1Interface",ApiGear::MQTT::Topic::TopicType::Operation,"func1"), this);
...
SameStruct1InterfaceService::~SameStruct1InterfaceService()
{
    ...
    m_client->unsubscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameStruct1Interface",ApiGear::MQTT::Topic::TopicType::Operation,"_setprop1"), this);
    m_client->unsubscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameStruct1Interface",ApiGear::MQTT::Topic::TopicType::Operation,"func1"), this);
}

    ...
    , m_service(service)
{
    ...
    m_service->subscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameEnum1Interface",ApiGear::MQTT::Topic::TopicType::Operation,"_setprop1"), std::bind(&SameEnum1InterfaceService::onInvoke, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));
    m_service->subscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameEnum1Interface",ApiGear::MQTT::Topic::TopicType::Operation,"func1"), std::bind(&SameEnum1InterfaceService::onInvoke, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));
...
SameEnum1InterfaceService::~SameEnum1InterfaceService()
{
    ...
    m_service->unsubscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameEnum1Interface",ApiGear::MQTT::Topic::TopicType::Operation,"_setprop1"), std::bind(&SameEnum1InterfaceService::onInvoke, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));
    m_service->unsubscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameEnum1Interface",ApiGear::MQTT::Topic::TopicType::Operation,"func1"), std::bind(&SameEnum1InterfaceService::onInvoke, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));
}

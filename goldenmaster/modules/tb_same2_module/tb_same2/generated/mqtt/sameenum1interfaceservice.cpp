...
SameEnum1InterfaceService::~SameEnum1InterfaceService()
{
    ...
    m_service->unsubscribeTopic(std::string("tb.same2/SameEnum1Interface/set/prop1"), std::bind(&SameEnum1InterfaceService::onSetProperty, this, std::placeholders::_1, std::placeholders::_2));
    m_service->unsubscribeTopic(std::string("tb.same2/SameEnum1Interface/rpc/func1"), std::bind(&SameEnum1InterfaceService::onInvoke, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));
}

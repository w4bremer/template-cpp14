...
{
    m_client->subscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameEnum2Interface",ApiGear::MQTT::Topic::TopicType::Property,"prop1"), this);
    m_client->subscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameEnum2Interface",ApiGear::MQTT::Topic::TopicType::Property,"prop2"), this);
    m_client->subscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameEnum2Interface",ApiGear::MQTT::Topic::TopicType::Signal,"sig1"), this);
    m_client->subscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameEnum2Interface",ApiGear::MQTT::Topic::TopicType::Signal,"sig2"), this);
    m_client->subscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameEnum2Interface",ApiGear::MQTT::Topic::TopicType::Operation,"func1",m_client->getClientId()+"/result"), nullptr);
    m_client->subscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameEnum2Interface",ApiGear::MQTT::Topic::TopicType::Operation,"func2",m_client->getClientId()+"/result"), nullptr);
}

SameEnum2InterfaceClient::~SameEnum2InterfaceClient()
{
    m_client->unsubscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameEnum2Interface",ApiGear::MQTT::Topic::TopicType::Property,"prop1"), this);
    m_client->unsubscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameEnum2Interface",ApiGear::MQTT::Topic::TopicType::Property,"prop2"), this);
    m_client->unsubscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameEnum2Interface",ApiGear::MQTT::Topic::TopicType::Signal,"sig1"), this);
    m_client->unsubscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameEnum2Interface",ApiGear::MQTT::Topic::TopicType::Signal,"sig2"), this);
    m_client->unsubscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameEnum2Interface",ApiGear::MQTT::Topic::TopicType::Operation,"func1",m_client->getClientId()+"/result"), nullptr);
    m_client->unsubscribeTopic(ApiGear::MQTT::Topic("tb.same2","SameEnum2Interface",ApiGear::MQTT::Topic::TopicType::Operation,"func2",m_client->getClientId()+"/result"), nullptr);
}

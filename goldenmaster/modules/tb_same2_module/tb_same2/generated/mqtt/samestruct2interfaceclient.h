...
namespace TbSame2 {
namespace mqtt {
class TEST_TB_SAME2_EXPORT SameStruct2InterfaceClient : public ISameStruct2Interface, public virtual ApiGear::MQTTImpl::ISink
{
public:
    explicit SameStruct2InterfaceClient(std::shared_ptr<ApiGear::MQTTImpl::Client> client);

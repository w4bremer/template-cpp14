...
namespace TbSame2 {
namespace mqtt {
class TEST_TB_SAME2_EXPORT SameEnum1InterfaceClient : public ISameEnum1Interface, public virtual ApiGear::MQTTImpl::ISink
{
public:
    explicit SameEnum1InterfaceClient(std::shared_ptr<ApiGear::MQTTImpl::Client> client);

...
*/
class TEST_TB_SAME2_EXPORT RemoteSameStruct2Interface : public ISameStruct2Interface,
...
public:
    ...
    */
    ...
    /**
    * Informs if the remote RemoteSameStruct2Interface is ready to send and revice messages.
...
private:
    ...
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the RemoteSameStruct2Interface.

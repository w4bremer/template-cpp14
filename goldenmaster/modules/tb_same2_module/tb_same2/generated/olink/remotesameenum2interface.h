...
*     It provides a network implementation and tools to connect RemoteSameEnum2Interface to it.
...
*/
class TEST_TB_SAME2_EXPORT RemoteSameEnum2Interface : public ISameEnum2Interface,
...
public:
    ...
    /** ctor */
    explicit RemoteSameEnum2Interface();
    /** dtor */
    virtual ~RemoteSameEnum2Interface() = default;
    /**
    * Property getter

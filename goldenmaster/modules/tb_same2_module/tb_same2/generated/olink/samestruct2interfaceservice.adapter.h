...
*/
class TEST_TB_SAME2_EXPORT SameStruct2InterfaceServiceAdapter : public ApiGear::ObjectLink::IObjectSource, public ISameStruct2InterfaceSubscriber
{
public:
    /**
    * ctor
    ...
    */
    explicit SameStruct2InterfaceServiceAdapter(std::shared_ptr<ISameStruct2Interface> SameStruct2Interface, ApiGear::ObjectLink::RemoteRegistry& registry);
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the SameStruct2Interface object.
...
private:
    ...
    */
    std::shared_ptr<ISameStruct2Interface> m_SameStruct2Interface;
    /**
